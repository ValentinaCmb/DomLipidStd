...
MW.table <- read.table(header = TRUE, text = '
                       ...
                       DAG  36:2  18:1  637.5637  100
                       PC  36:2  na  785.5898  100
                       PCp  38:4  18:1  807.5740  100
                       LPC  18:1  na  521.348  100
                       PEp  36:1  18:0  729.5646  100 
                       PG  36:1  18:1  776.5495  100
                       PI  34:2  16:0  834.5245  100
                       PS  34:2  17:1  763.5350  100
                       SM  35:1  18:1  716.5815  100
                       FA  18:1  na  282.2554  100
                       Cer 35:1  d18:1  551.5266 100'
)
MW.table
...
standards <- read.table(header = TRUE, stringsAsFactors = FALSE, text = '
                        ...
                        PS  PS  1 Phospholipid
                        PG  PG  1 Phospholipid
                        SM  SM  1 Sphingolipid
                        Cer  Cer  1  Ceramide
                        FA  FA  1 Free Fatty Acid
                        ') 
